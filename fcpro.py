...
#AUTHOR : AMUL SHARMA(MR.KING)

#OPEN SOURCE :)

#DON'T FORGET TO GIVE CREDIT TO MR. AMUL SHARMA 
...
⠀⠀  ╔═════════════════════════════╗\n    ║ TOOL NAME: { FCPRO }        ║\n    ║ AUTHOR   : MR. AMUL SHARMA.     ║\n    ║ GITHUB   : git.io/NARUTOXX    ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https:/AMUL-KING/github.com//fcpro")
		...
		xox("\n\t\033[91;1m GOOD BYE SEE YOU AGAIN ❤️🤝 :)")
